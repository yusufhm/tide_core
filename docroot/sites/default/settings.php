...
if(getenv('LAGOON_ENVIRONMENT_TYPE')){
  ...
  if (file_exists(__DIR__ . '/envs/' . getenv('LAGOON_ENVIRONMENT_TYPE') . '/settings.php')) {
    include __DIR__ . '/envs/' . getenv('LAGOON_ENVIRONMENT_TYPE') . '/settings.php';
  }

  // Environment specific services files.
  if (file_exists(__DIR__ . '/envs/' . getenv('LAGOON_ENVIRONMENT_TYPE') . '/services.yml')) {
    $settings['container_yamls'][] = __DIR__ . '/envs/' . getenv('LAGOON_ENVIRONMENT_TYPE') . '/services.yml';
  }
}
